...
class SeriesControllerTest < ActionController::TestCase
  ...
  test "should create serie" do
    assert_difference('Serie.count') do
      post :create, serie: { descripcion: @serie.descripcion, en_transmision: @serie.en_transmision, nombre: @serie.nombre }
    end
  ...
  test "should update serie" do
    patch :update, id: @serie, serie: { descripcion: @serie.descripcion, en_transmision: @serie.en_transmision, nombre: @serie.nombre }
    assert_redirected_to serie_path(assigns(:serie))
  end
